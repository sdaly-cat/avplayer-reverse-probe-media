...
[m]drawtext=fontfile=${FONT}:text='${WIDTH}x${HEIGHT} | 59.94 fps | H.264 High | ${gop_label} GOP-${GOP}':x=40:y=40:fontsize=44:fontcolor=white:box=1:boxcolor=black@0.55:boxborderw=14[m2];\
